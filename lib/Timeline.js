...
var _HelpersContext = require("./timeline/HelpersContext");
...
var ReactCalendarTimeline = /*#__PURE__*/function (_Component) {
  ...
  function ReactCalendarTimeline(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "resize", function () {
      ...
      var _stackTimelineItems = (0, _calendar.stackTimelineItems)(props.items, props.groups, canvasWidth, _this.state.canvasTimeStart, _this.state.canvasTimeEnd, props.keys, props.lineHeight, props.itemHeightRatio, props.stackItems, _this.state.draggingItem, _this.state.resizingItem, _this.state.dragTime, _this.state.resizingEdge, _this.state.resizeTime, _this.state.newGroupId),
          groupsWithItemsDimensions = _stackTimelineItems.groupsWithItemsDimensions,
    ...
    _defineProperty(_assertThisInitialized(_this), "dragItem", function (item, dragTime, newGroupId) {
      _this.setState({
        draggingItem: item,
        dragTime: dragTime,
    ...
    _defineProperty(_assertThisInitialized(_this), "dropItem", function (item, dragTime, newGroupId) {
      _this.setState({
        draggingItem: null,
        dragTime: null
      });
      ...
      if (_this.props.onItemMove) {
        _this.props.onItemMove(item, dragTime, newGroupId);
      }
    });
    ...
    var _stackTimelineItems2 = (0, _calendar.stackTimelineItems)(_props.items, _props.groups, _canvasWidth, _this.state.canvasTimeStart, _this.state.canvasTimeEnd, _props.keys, _props.lineHeight, _props.itemHeightRatio, _props.stackItems, _this.state.draggingItem, _this.state.resizingItem, _this.state.dragTime, _this.state.resizingEdge, _this.state.resizeTime, _this.state.newGroupId),
        _groupsWithItemsDimensions = _stackTimelineItems2.groupsWithItemsDimensions,
        ...
        itemsWithInteractions = _stackTimelineItems2.itemsWithInteractions;
    /* eslint-disable react/no-direct-mutation-state */


    _this.state.groupsWithItemsDimensions = _groupsWithItemsDimensions;
    _this.state.height = _height;
    _this.state.groupHeights = _groupHeights;
    _this.state.groupTops = _groupTops;
    _this.state.itemsWithInteractions = itemsWithInteractions;
    /* eslint-enable */
  ...
  _createClass(ReactCalendarTimeline, [{
    ...
    value: function render() {
      ...
      var _this$state5 = this.state,
          groupsWithItemsDimensions = _this$state5.groupsWithItemsDimensions,
          height = _this$state5.height,
          groupHeights = _this$state5.groupHeights,
          groupTops = _this$state5.groupTops,
          itemsWithInteractions = _this$state5.itemsWithInteractions;
      var zoom = visibleTimeEnd - visibleTimeStart;
      var canvasWidth = (0, _calendar.getCanvasWidth)(width);
      ...
      return /*#__PURE__*/_react["default"].createElement(_TimelineStateContext.TimelineStateProvider, {
      ...
      }, /*#__PURE__*/_react["default"].createElement(_HelpersContext.HelpersContextProvider, {
        groupsWithItemsDimensions: groupsWithItemsDimensions,
      ...
      }, /*#__PURE__*/_react["default"].createElement(_MarkerCanvas["default"], null, this.childrenWithProps(), /*#__PURE__*/_react["default"].createElement(_Rows["default"], {
        items: isInteractingWithItem ? itemsWithInteractions : items,
        groupHeights: groupHeights,
        ...
        groupsWithItemsDimensions: groupsWithItemsDimensions //props
        ,
        groups: groups,
        keys: keys,
      ...
      }), hideHorizontalLines ? null : /*#__PURE__*/_react["default"].createElement(_Columns["default"], {
