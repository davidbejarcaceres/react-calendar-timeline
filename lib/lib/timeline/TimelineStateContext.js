...
exports["default"] = exports.TimelineStateConsumer = exports.TimelineStateProvider = void 0;
...
var TimelineStateContext = (0, _createReactContext["default"])(defaultContextState);
var Consumer = TimelineStateContext.Consumer,
    Provider = TimelineStateContext.Provider;

var TimelineStateProvider = /*#__PURE__*/function (_React$Component) {
  _inherits(TimelineStateProvider, _React$Component);

  var _super = _createSuper(TimelineStateProvider);
...
_defineProperty(TimelineStateProvider, "propTypes", (_defineProperty2 = {
...
}, _defineProperty(_defineProperty2, "showPeriod", _propTypes["default"].func.isRequired), _defineProperty(_defineProperty2, "timelineUnit", _propTypes["default"].string.isRequired), _defineProperty(_defineProperty2, "timelineWidth", _propTypes["default"].number.isRequired), _defineProperty(_defineProperty2, "keys", _propTypes["default"].object.isRequired), _defineProperty2));

var TimelineStateConsumer = Consumer;
exports.TimelineStateConsumer = TimelineStateConsumer;
var _default = TimelineStateContext;
