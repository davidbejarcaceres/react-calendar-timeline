...
var ColumnsWrapper = /*#__PURE__*/function (_PureComponent) {
  _inherits(ColumnsWrapper, _PureComponent);

  var _super2 = _createSuper(ColumnsWrapper);

  function ColumnsWrapper() {
    _classCallCheck(this, ColumnsWrapper);

    return _super2.apply(this, arguments);
  }

  _createClass(ColumnsWrapper, [{
    key: "render",
    value: function render() {
      var _this = this;
