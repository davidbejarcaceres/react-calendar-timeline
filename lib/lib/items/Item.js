      ...
      (0, _interactjs["default"])(this.item).resizable({
        ...
        if (_this2.props.dragging) {
          if (e.dropzone) {
            ...
            if (dragTime !== (0, _generic._get)(_this2.props.item, _this2.props.keys.itemTimeStartKey)) {
              if (_this2.props.moveResizeValidator) {
                dragTime = _this2.props.moveResizeValidator('move', _this2.props.item, dragTime, undefined, parseInt(newGroupId, 10));
              }
